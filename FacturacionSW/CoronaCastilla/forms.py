...
class FacturaForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'desayuno_cantidad': forms.NumberInput(attrs={'class': 'plantilla__form__tabla__tbody__trow__tdata__input', 'name': 'cantidadDesayuno', 'id': 'desayunoCantidad', 'onchange': 'precioDesayunos()'}),
            'desayuno_precio': forms.NumberInput(attrs={'class': 'plantilla__form__tabla__tbody__trow__tdata__input', 'name': 'precioDesayuno', 'id': 'desayunoPrecio', 'onchange': 'precioDesayunos()'}),
