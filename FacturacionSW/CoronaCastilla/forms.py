...
class FacturaForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'desayuno2_cantidad': forms.NumberInput(attrs={'class': 'plantilla__form__tabla__tbody__trow__tdata__input', 'name': 'cantidadDesayuno2', 'id': 'desayunoCantidad2', 'onchange': 'showResults()', 'value': 0}),
            'desayuno2_precio': forms.NumberInput(attrs={'class': 'plantilla__form__tabla__tbody__trow__tdata__input', 'name': 'precioDesayuno2', 'id': 'desayunoPrecio2', 'onchange': 'showResults()', 'value': 0}),
